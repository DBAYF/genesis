...
const configSchema = z.object({
  ...
  // HMRC API
  HMRC_API_KEY: z.string().optional(),
  HMRC_BASE_URL: z.string().default('https://api.service.hmrc.gov.uk'),

  // Companies House API
  COMPANIES_HOUSE_API_KEY: z.string().optional(),
  COMPANIES_HOUSE_BASE_URL: z.string().default('https://api.company-information.service.gov.uk'),

  // Compliance Settings
  DEFAULT_REMINDER_DAYS: z.string().default('30,14,7,3,1'),
  DEADLINE_CHECK_INTERVAL: z.string().default('86400000'), // 24 hours
